...
export default function PostOdooJournalFormView({ form, alurkerjaParams }: Readonly<AlurkerjaMfeProps>) {
    ...
    useEffect(() => {
        ...
        const fetchAccounts = async () => {
            ...
            try {
                ...
                url.searchParams.append('company_id', String(watchedCompanyId));
                url.searchParams.append('limit', '999'); // Adjust limit as needed
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            isDisabled={isLoadingCompanies || !!companiesError}
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            isDisabled={!watchedCompanyId || isLoadingJournals || !!journalsError}
                            placeholder={
                                !watchedCompanyId
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            isDisabled={!watchedCompanyId || isLoadingDebitAccounts || !!accountsError}
                            placeholder={
                                !watchedCompanyId
                                    ? 'Select a company first'
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            isDisabled={!watchedCompanyId || isLoadingCreditAccounts || !!accountsError}
                            placeholder={
                                !watchedCompanyId
                                    ? 'Select a company first'
